  ...
  return (
    <AppLayout filters={filters} onFiltersChange={setFilters}>
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">Add a new document to the IKMS knowledge base.</p>

        {success && (
          <div className="mb-6 flex items-center gap-3 rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-green-800">
            <CheckCircle2 className="h-5 w-5" />
            <span className="text-sm font-medium">Document uploaded successfully! Redirecting...</span>
          </div>
        )}

        <form onSubmit={onSubmit} className="bg-card rounded-lg border shadow-sm p-6 space-y-5">
          <div>
            <label className="block text-sm font-semibold mb-1.5">Document Title</label>
          ...
          <div>
            <label className="block text-sm font-semibold mb-1.5">File Upload</label>
